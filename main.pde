...
int framesInAnimation=180; // intermediate frames for the whole animation 
...
void setup()               // executed once at the begining 
  ...
  PictureOfMyFace = loadImage("data/me.jpg");  // load image from file JR.jpg in folder data *** replace that file with your pic of your own face
...
void draw()      // executed at each frame
  ...
  f(black);
  scribeHeader("global time = "+nf(currentTime,0,2),2);
